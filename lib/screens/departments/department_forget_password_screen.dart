...
class DepartmentForgetPasswordScreen extends StatefulWidget {
  final String email;
  final Map<String, String> user;
  final String shopName;

  const DepartmentForgetPasswordScreen({
    super.key,
    required this.email,
    required this.user,
  ...
  @override
  _DepartmentForgetPasswordScreenState createState() =>
      _DepartmentForgetPasswordScreenState();
}

class _DepartmentForgetPasswordScreenState
    extends State<DepartmentForgetPasswordScreen> {
  ...
  Future<void> _sendConfirmationCode() async {
    ...
    try {
      final departments = await _checkDepartmentExists(department);

      if (departments == null) {
        _showErrorDialog(
            'Selected Department is not Corrected. Please Choose Corrected Department.');
        setState(() {
          _isLoading = false;
        });
        return;
      ...
      // Proceed to generate, insert, and send the confirmation code
  ...
  Future<Map<String, dynamic>?> _checkDepartmentExists(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      'Remember Department Password? Log In',
                      style: TextStyle(
                        fontSize: 18,
                        fontFamily: 'RobotoCondensed',
                        color: Colors.black,
