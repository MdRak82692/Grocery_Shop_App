...
class AddSuppliesProfileScreen extends StatefulWidget {
  final String email;
  final String department;
  final Map<String, String> user;
  final String shopName;

  const AddSuppliesProfileScreen({
    Key? key,
    required this.email,
  ...
  @override
  _AddSuppliesProfileScreenState createState() =>
      _AddSuppliesProfileScreenState();
}

class _AddSuppliesProfileScreenState extends State<AddSuppliesProfileScreen> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController _suppliesNameController = TextEditingController();
  final TextEditingController _contactNumberController =
      TextEditingController();
  final TextEditingController _supplyCompanyNameController =
      TextEditingController();
  ...
  Future<void> _addSuppliesProfile() async {
    ...
    try {
      ...
      final newProfile = SuppliesProfile(
        id: mongo.ObjectId(),
      ...
      _showSuccessDialog('Suppliers Profile has been Insert Successfully.');
    } catch (e) {
      _showErrorDialog('Failed to add suppliers profile. Error: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Enter Suppliers Profile Details',
          style: TextStyle(
            fontSize: 26,
            fontFamily: 'RobotoCondensed',
            fontWeight: FontWeight.bold,
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20),
                  ElevatedButton(
                    onPressed: _addSuppliesProfile,
                    child: Container(
                      padding:
                          EdgeInsets.symmetric(vertical: 12, horizontal: 20),
                      child: Text(
                        'Add Suppliers Profile Information',
                        style: TextStyle(
                          fontSize: 20,
                          fontFamily: 'RobotoCondensed',
                          fontWeight: FontWeight.bold,
